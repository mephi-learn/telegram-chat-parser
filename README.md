...
> **Обратная совместимость:** Для упрощения миграции поддерживается старый формат конфигурации с одним аккаунтом в корне `telegram_api`. Однако этот формат считается устаревшим.
>
